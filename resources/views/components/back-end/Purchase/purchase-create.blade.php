            ...
            <form id="signup" onsubmit="return Save(event)">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" class="input-style" id="PurchaseDate" required /><br />
                    </div>

                    <!-- Reference Number -->
                    <div class="col-md-6 mb-4">
                        <label class="form-label">Reference No <span class="text-danger">*</span></label>
                        <input type="text" class="input-style" id="ReferenceNo" required /><br />
                    </div>

                    <!-- Status -->
                    <div class="col-md-6 mb-4">
                        <label class="form-label">Status <span class="text-danger">*</span></label>
                        <select name="status" class="form-select input-style" id="SelectStatus" required>
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type="text" id="grandSubtotal" class="form-control"
                                            readonly /></td>
                                </tr>
                                <tr>
                                    <th colspan="5">Discount</th>
                                    <td>
                                        <input type="number" id="overallDiscount" value="0" min="0"
                                            class="form-control" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" id="paymentDetails" class="form-control"
                                            style="display: none;" placeholder="Enter transaction details" />
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-lg-6">
                        <div class="upload-profile">
                            <button type="submit" class="submit" onclick="Save(event)">Submit</button>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <label class="data">
                                                <input type="text" name="number"
                                                    placeholder="Enter your number name" id="WarehouseNumber" /><br />
                                            </label>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="data">
                                                <input type="text" name="email"
                                                    placeholder="Enter your email name" id="WarehouseEmail" /><br />
                                            </label>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="data">
...
<script>
    ...
    function updateTotals() {
        ...
        rows.forEach(row => {
            ...
            const price = parseFloat(row.cells[4].innerText); // Updated index to match price cell
...
<script>
    // Your existing code for displaying products and managing the order table

    async function Save(event) {
        event.preventDefault();

        // Collect product data from the table rows
        let products = [];
        const rows = document.querySelectorAll('#orderTableBody tr');
        rows.forEach(row => {
            const productId = row.cells[1].innerText; // Update if necessary to match product ID cell
        ...
        formData.append('wareshop_id', document.getElementById('ADDWareShop').value);
        ...
        formData.append('subtotal', parseFloat(document.getElementById('totalSubTotal').innerText) || 0);
        formData.append('referance_no', document.getElementById('ReferenceNo').value);
        formData.append('discount', parseFloat(document.getElementById('overallDiscount').value) || 0);
        formData.append('paid', parseFloat(document.getElementById('paidAmount').value) || 0);
        formData.append('due', parseFloat(document.getElementById('dueAmount').value) || 0);
        ...
        try {
            const response = await axios.post("/api/create-purchases", formData, {
                headers: {
            ...
            console.error(error);
            errorToast("An error occurred: " + (error.response?.data?.message || "Please try again"));
        }
    }
</script>
